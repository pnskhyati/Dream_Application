...
import { ai, UsersIcon, CheckCircleIcon, DocumentIcon, MonitorAvatarIcon } from './common';
import VerbalInterview from './verbal-interview';
        ...
        <div className="ai-prep-hub-container">
            ...
            <main className="ai-prep-hub-main">
                <div className="tabs-container">
                    ...
                    <button className={`tab-button ${activeTab === 'verbal-interview' ? 'active' : ''}`} onClick={() => setActiveTab('verbal-interview')}><MonitorAvatarIcon /> Live Interview</button>
                </div>
                ...
                {activeTab === 'verbal-interview' && (
                    <div className="tab-content">
                    <p className="tool-description">Take verbal interview using AI Avatar.</p>
                    <VerbalInterview />
                    </div>
                )}
            </main>
